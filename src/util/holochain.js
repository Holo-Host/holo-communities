...
export const HOLOCHAIN_DEFAULT_COMMUNITIES = [
  { slug: 'hylo-holochain', name: 'Hylo Holochain' },
  { slug: 'holoport-owners', name: 'HoloPort Owners' },
  { slug: 'holoport-support', name: 'HoloPort Support' }
]
